...
//                                 {vacantPlaces}
//                             </Text>
//                             <Text style={styles.box} onPress={toggleModal}>
//                                 <Text style={styles.boldText}>Phone: </Text>
//                                 {phoneNumber}
//                             </Text>
//                             {comments ? (
...
//                         <Text style={styles.modalButtonText}>Chat on WhatsApp</Text>
//                     </TouchableOpacity>
//                     <TouchableOpacity style={styles.modalButton} onPress={handleCall}>
//                         <Text style={styles.modalButtonText}>Call Phone Number</Text>
//                     </TouchableOpacity>
...
// //         <View style={styles.container}>
// //             <View style={styles.headerRow}>
// //                 {/* <Image source={groupProfileImage} style={styles.groupProfileImage} /> */}
// //                 <View style={styles.infoText}>
// //                     <Text style={[styles.rowText, { fontWeight: 'bold', fontSize: 16, paddingBottom: 5 }]}>{fullName} has offered a ride!</Text>
// //                     <Text style={styles.rowText}>
// //                         <Text style={styles.boldText}>From: </Text>
